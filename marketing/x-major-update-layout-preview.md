...
> Gongwen Skill 2.0 重大更新。这里是图文排版预览稿，头图、文章插图和实际验证截图已经按正文阅读顺序合并。标注“文章插图”的是 X Article 配图，标注“实际验证截图”的是仓库中保留的核验证据。
...
![实际验证截图｜带份号、密级和紧急程度的电子红头首页](../references/assets/visual-audit/all-rules/formal-digital-all-1.png)
...
![实际验证截图｜预印红头纸套打模式的首页留白](../references/assets/visual-audit/all-rules/formal-preprinted-1.png)
...
![实际验证截图｜附件另页后的标题与正文版式](../references/assets/visual-audit/all-rules/formal-attachments-3.png)
...
![实际验证截图｜横排表格场景](../references/assets/visual-audit/all-rules/horizontal-table-1.png)

*实际验证截图｜横排表格已生成，单双页表头方向仍需在目标 Word 或 WPS 中核对。*
